          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
              <div className="_social_registration_content">
                ...
                {googleEnabled ? (
                  <a href="/api/auth/google" className="_social_registration_content_btn _mar_b40">
                    <img src="/assets/js/images/google.svg" alt="" className="_google_img" /> <span>Continue with Google</span>
                  </a>
                ) : (
                  <p className="text-xs text-gray-400 mb-6">
                    Google sign-up isn&apos;t configured for this deployment — fill in the form below, or head to{' '}
                    <Link href="/login" className="underline">
                      Login
                    </Link>{' '}
                    to try the &quot;Continue with Demo Account&quot; option instead.
                  </p>
                )}
