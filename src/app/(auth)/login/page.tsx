            ...
            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
              <div className="_social_login_content">
                ...
                <button
                  ...
                  onClick={() => toast("Google sign-in isn't part of this demo scope.", { icon: '🚧' })}
                >
                  <img src="/assets/js/images/google.svg" alt="" className="_google_img" /> <span>Or sign-in with google</span>
                </button>
